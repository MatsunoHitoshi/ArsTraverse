...
import { RelativeTimeWithTooltip } from "../../curators-writing-workspace/relative-time-with-tooltip";
import {
...
export const PublicAnnotationList: React.FC<PublicAnnotationListProps> = ({
  annotations,
  topicSpaceId,
  setFocusedNode,
