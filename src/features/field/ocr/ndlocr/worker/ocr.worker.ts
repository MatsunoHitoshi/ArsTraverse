// @ts-nocheck — ported from ndlocrlite-web; ONNX tensor typings are intentionally loose.
/**
 * OCR Web Worker
 * バックグラウンドでOCR処理を実行
...
class OCRWorker {
  ...
  private recognizer30: TextRecognizer | null = null  // ≤30文字 [1,3,24,256]
  private recognizer50: TextRecognizer | null = null  // ≤50文字 [1,3,24,384]
  private recognizer100: TextRecognizer | null = null // ≤100文字 [1,3,24,768]
