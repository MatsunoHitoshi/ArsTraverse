...
export default function AnnotationDetailPage() {
  ...
  if (annotationLoading) {
    return (
      <div className="flex h-screen items-center justify-center">
        <div className="text-lg text-gray-400">{tCommon("loading")}</div>
      </div>
    );
  }
  ...
  if (!annotation) {
    return (
      <div className="flex h-screen items-center justify-center">
        <div className="text-lg text-gray-400">{t("notFound")}</div>
      </div>
    );
  }
            ...
            <div className="flex w-full flex-row items-center gap-2">
              ...
              {annotation.targetRelationship && (
                <>
                  ...
                  <span className="text-sm text-gray-400">
                    {t("relationshipLabel", {
                      type: annotation.targetRelationship.type,
                    })}
                  </span>
                </>
              )}
