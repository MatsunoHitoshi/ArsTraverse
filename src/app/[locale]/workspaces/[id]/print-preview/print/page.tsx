...
export default function PrintPage() {
  ...
  const tTopicSpace = useTranslations("topicSpace");
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-white">
        <div className="text-center">
          <h1 className="mb-4 text-2xl font-bold">{tCommon("error")}</h1>
          <p className="text-red-400">
            {t("topicSpaceNotFound")}
          </p>
        </div>
      </div>
    );
  ...
  if (!graphData) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-white">
        <div className="text-center">
          <h1 className="mb-4 text-2xl font-bold">{tView("noGraph")}</h1>
          <p className="text-gray-400">
            {tTopicSpace("graphNotCreated")}
          </p>
        </div>
      </div>
    );
  ...
  if (!metaGraphData) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-white">
        <div className="text-center">
          <h1 className="mb-4 text-2xl font-bold">{tPrint("noStory")}</h1>
          <p className="text-gray-400">
            {t("noStoryShort")}
          </p>
        </div>
