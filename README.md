...
Concept and flow diagrams for the writing workspace, story generation, auto-highlighting, field research, graph statistics, and the public scroll-linked storytelling viewer live under `docs/`. Notable entries:
...
- `docs/workspace-router-api.md` — workspace CRUD, writing history, liveGraph, upsertBySource, text completion, publish
- `docs/print-router-api.md` — server-side PDF via Puppeteer (`print.generatePdf`)
